...
/* common_rtl.c normally owns this; the ref build has no common_rtl.c.
 * The interp bridge reads it to suppress the synthetic per-touch APU
 * catch-up while the accurate ref drives the SPC itself — zero here. */
